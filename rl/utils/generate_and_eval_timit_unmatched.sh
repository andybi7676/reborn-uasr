segmenter_dir=../cnn_segmenter/output/local/rl_agent/new_timit_unmatched_from_bc_relative_to_viterbi_more_epoch_ppl_norm
...
python postprocess_boundaries.py \
    ...
    --length_fpath ../../data/audio/timit/unmatched/large_clean/precompute_pca512/$split.lengths
...
python eval_boundaries.py --hyp $output_dir/raw/$split.postprocessed.bds --ref ../../data/audio/timit/unmatched/large_clean/GOLDEN/$split.bds >> $output_dir/result.txt
