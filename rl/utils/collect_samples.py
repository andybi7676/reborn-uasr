...
def main(args):
    ...
    ref_wrd_fpath = osp.join(args.ref_dir, f"{args.split}.wrd")
    ...
    summary = []
    for i, src_hyp, src_raw, tgt_hyp, tgt_raw, phn_ref, wrd_ref in zip(range(len(phn_refs)), src_hyps, src_raws, tgt_hyps, tgt_raws, phn_refs, wrd_refs):
        ...
        new_item = (i, src_ter, tgt_ter, src_hyp, tgt_hyp, src_raw, tgt_raw, phn_ref, wrd_ref)
