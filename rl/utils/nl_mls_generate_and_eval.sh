segmenter_dir=../cnn_segmenter/output/rl_agent/mls_nl/MLS_NL_pplNorm1.0_tokerr0.2_lenratio0.2_lr1e-4_epoch40_seed3
segmenter_ckpt=$segmenter_dir/rl_agent_segmenter_best.pt
generator_ckpt=../../s2p/multirun/nl_mls/xlsr_100hr/nl_unpaired_all/best_unsup/checkpoint_best.pt
