...
segmenter_dir=../cnn_segmenter/output/rl_agent/mls_nl/MLS_NL_pplNorm1.0_tokerr0.2_lenratio0.4_lr1e-4_epoch40_seed3_postITER1
segmenter_ckpt=$segmenter_dir/rl_agent_segmenter_best.pt
generator_ckpt=../../s2p/multirun/nl_mls/xlsr_100hr_postITER1/nl_unpaired_all/best_unsup/checkpoint_best.pt
output_dir=$segmenter_dir
config_name=nl_mls
feats_dir=../../data2/nl_mls/xlsr_100hr/precompute_pca512
golden_dir=../../data2/nl_mls/labels/100hr
