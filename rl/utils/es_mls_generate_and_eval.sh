...
segmenter_dir=../cnn_segmenter/output/rl_agent/mls_es/MLS_ES_pplNorm1.0_tokerr0.2_lenratio0.0_lr1e-4_epoch40_seed3_postITER1
segmenter_ckpt=$segmenter_dir/rl_agent_segmenter_best.pt
generator_ckpt=../../s2p/multirun/es_mls/xlsr_100hr_postITER1/es_unpaired_all/best_unsup/checkpoint_best.pt
