...
segmenter_dir=../cnn_segmenter/output/ablation/ls_en/LS_EN_pplNorm1.0_tokerr0.4_lenratio0.0_lr1e-4_epoch40_seed3
...
all_splits="test"
# all_splits="valid test dev-other test-other valid_small"
