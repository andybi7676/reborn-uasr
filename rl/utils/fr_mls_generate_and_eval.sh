...
segmenter_dir=../cnn_segmenter/output/rl_agent/mls_fr/MLS_FR_pplNorm1.0_tokerr0.2_lenratio0.0_lr1e-4_epoch40_seed3_postITER1
segmenter_ckpt=$segmenter_dir/rl_agent_segmenter_best.pt
generator_ckpt=../../s2p/multirun/fr_mls/xlsr_100hr_postITER1/fr_unpaired_all/best_unsup/checkpoint_best.pt
output_dir=$segmenter_dir
config_name=fr_mls
feats_dir=../../data/fr_mls/xlsr_100hr/precompute_pca512
golden_dir=../../data/fr_mls/labels/100hr
