...
if [ -d ${output_dir}/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}${posttag} ]; then
    echo "Directory exists: ${output_dir}/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}${posttag}"
    continue
fi
...
python3 train_rl_cnnagent_enpei.py \
    ...
    --pretrain_segmenter_path ./output/cnn_segmenter/${g_type}${tag}_pretrain_PCA_cnn_segmenter_kernel_size_7_v1_epo20_lr0.0005_wd0.0001_dropout0.1_optimAdamW_schCosineAnnealingLR/cnn_segmenter.pt \
    ...
    --learning_rate ${lr} \
    --seed ${seed} \
    --save_dir ${output_dir}/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}${posttag} \
    --save_interval 4 \
    --wandb_log
