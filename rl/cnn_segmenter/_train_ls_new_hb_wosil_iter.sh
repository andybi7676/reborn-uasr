...
if [ -d ${WORK_DIR}/output/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}_postITER${iter}${postfix} ]; then
    echo "Directory exists: ${WORK_DIR}/output/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}_postITER${iter}${postfix}"
    continue
fi
...
python3 train_rl_cnnagent_enpei.py \
    ...
    --kenlm_fpath ${WORK_DIR}/data/${dataset_name}/text/prep/phones/lm.phones.filtered.nosil.04.bin \
    ...
    --learning_rate ${lr} \
    --seed ${seed} \
    --save_dir ${WORK_DIR}/output/rl_agent/${tag}_${lang}/${g_type}${TAG}_${LANG}_pplNorm1.0_tokerr${coef_ter}_lenratio${coef_len}_lr${lr}_epoch40_seed${seed}_postITER${iter}${postfix} \
    --save_interval 4 \
